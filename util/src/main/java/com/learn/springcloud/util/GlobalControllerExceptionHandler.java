...
import com.learn.springcloud.util.exceptions.InvalidInputException;
...
public class GlobalControllerExceptionHandler {
    ...
    public @ResponseBody HttpErrorInfo handleInvalidIntpuException(ServerHttpRequest request, InvalidInputException ex) {
